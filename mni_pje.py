...
def extrair_informacao_do_xml_processo(xml_str, retornar_df=True):
    ...
    processo['Municipio-Reu'] = verifica_cliente_demandado(processo)
    processo['Tempo-Tramitacao'] = calcular_tempo_tramitacao(processo)
    processo['Movimentos-Relevantes'] = identificar_movimentos_relevantes(processo)
    processo['Descricao-Documentos'] = identificar_descricao_documentos(processo)
    processo['Termos-Relevantes'] = verificar_documentos_principais(processo)
